    ...
    <div className="w-full" suppressHydrationWarning>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 print:block print:w-full">
        ...
        <div className="bg-alt rounded-3xl border border-border p-8 shadow-sm print:border-none print:shadow-none print:p-0 print:bg-transparent print:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-border pb-4 mb-6 print:hidden gap-4">
            ...
            {results.length > 0 && (
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <button 
                  ...
                  suppressHydrationWarning
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-navy text-white rounded-lg text-sm font-bold shadow-sm hover:bg-brand transition-colors"
                >
                ...
                <button 
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-green-500 text-white rounded-lg text-sm font-bold shadow-sm hover:bg-green-600 transition-colors"
                >
