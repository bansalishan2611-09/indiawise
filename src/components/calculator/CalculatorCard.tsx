...
export default function CalculatorCard({ definition }: { definition: CalculatorDefinition }) {
  const href = `/calculators/${definition.categorySlug}/${definition.slug}`;
  return (
    <Link href={href} className="group bg-white rounded-3xl p-6 border border-border hover:border-brand hover:shadow-md transition-all duration-200 flex flex-col justify-between">
      <div>
